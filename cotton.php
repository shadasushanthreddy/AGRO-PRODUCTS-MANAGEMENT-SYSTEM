      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="cotton.php">Cotton</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Cotton</h1>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              ...
              <div class="card mt-4">
                <img class="card-top img-fluid" src="https://supima.com/wp-content/themes/supima/theme-files/dist/assets/img/nav/industry.png" alt="">
                <div class="card-body">
                  <h3 class="card-title">Cotton</h3>
          ...
          $query2=mysqli_query($con,"Select product_price from product where product_name='cotton'");
...
?> per kg</h4>
              ...
              <div class="card card-outline-secondary my-4">
               ...
               $con=mysqli_connect("localhost","root","","agro_product");
                mysqli_connect("localhost","root","") or die(mysqli_error());
                mysqli_select_db($con,"agro_product") or die("Cannot connect to database");
          $query2=mysqli_query($con,"Select inv from product where product_name='cotton'");
          $row=mysqli_fetch_assoc($query2);
          printf("%d",$row["inv"]);
