      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="maize.php">Maize</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Maize</h1>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              ...
              <div class="card mt-4">
                <img class="card-img-top img-fluid" src="https://www.essence.com/wp-content/uploads/2019/02/GettyImages-507457626.jpg?width=1920&height=1080" alt="">
                <div class="card-body">
                  <h3 class="card-title">Maize</h3>
          ...
          $query2=mysqli_query($con,"Select product_price from product where product_name='maize'");
...
?> per kg</h4>
              ...
              <div class="card card-outline-secondary my-4">
               ...
               $con=mysqli_connect("localhost","root","","agro_product");
                mysqli_connect("localhost","root","") or die(mysqli_error());
                mysqli_select_db($con,"agro_product") or die("Cannot connect to database");
          $query2=mysqli_query($con,"Select inv from product where product_name='maize'");
          $row=mysqli_fetch_assoc($query2);
          printf("%d",$row["inv"]);
