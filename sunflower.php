      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="sunflower.php">Sunflower</a>
          </div>
        </div>
      </li>
    </ul>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Sunflower</h1>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              ...
              <div class="card mt-4">
                <img class="card-img-top img-fluid" src="https://i.ndtvimg.com/mt/cooks/2014-11/sunflower-seeds.jpg" alt="">
                <div class="card-body">
                  <h3 class="card-title">Sunflower</h3>
          ...
          $query2=mysqli_query($con,"Select product_price from product where product_name='sunflower'");
...
?> per kg</h4>
              ...
              <div class="card card-outline-secondary my-4">
               ...
               $con=mysqli_connect("localhost","root","","agro_product");
                mysqli_connect("localhost","root","") or die(mysqli_error());
                mysqli_select_db($con,"agro_product") or die("Cannot connect to database");
          $query2=mysqli_query($con,"Select inv from product where product_name='sunflower'");
          $row=mysqli_fetch_assoc($query2);
          printf("%d",$row["inv"]);
